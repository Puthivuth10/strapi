...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    booking_code: Schema.Attribute.UID;
    ...
    service_time: Schema.Attribute.Time & Schema.Attribute.Required;
...
export interface ApiServiceReviewServiceReview
  extends Struct.CollectionTypeSchema {
  collectionName: 'service_reviews';
  info: {
    displayName: 'ServiceReview';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-review.service-review'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isHotDeal: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    service_reviews: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-review.service-review'
    >;
    start_price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    transactions: Schema.Attribute.Relation<
      'oneToMany',
      'api::transaction.transaction'
    >;
    type_of_service: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    payment_method: Schema.Attribute.Enumeration<
      ['Cash', 'ABA', 'Wing', 'PayWay']
    > &
      Schema.Attribute.Required;
    price_paid: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    scheduled_time: Schema.Attribute.DateTime & Schema.Attribute.Required;
    service: Schema.Attribute.Relation<'manyToOne', 'api::service.service'>;
    transaction_code: Schema.Attribute.UID;
...
export interface ApiTypeOfServiceTypeOfService
  extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    bookings: Schema.Attribute.Relation<'oneToMany', 'api::booking.booking'>;
    business_address: Schema.Attribute.String;
    ...
    favorites: Schema.Attribute.Relation<'manyToMany', 'api::service.service'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::service-review.service-review': ApiServiceReviewServiceReview;
